...
class PurchaseDao(db.Model):
    ...
    id = db.Column(String(38), primary_key=True)
    account_id = db.Column(String(38), nullable=False)
    ...
    def get_all():
        ...
        Returns all purchases in the database
        """
        return db.session.query(PurchaseDao).all()
    ...
    def get_by_id(id):
        ...
        Returns the purchase with the given id
        """
        return db.session.query(PurchaseDao).filter_by(id=id).first()
    ...
    def get_by_account_id(account_id):
        ...
        """
        return db.session.query(PurchaseDao).filter_by(account_id=account_id).all() 
...
class PurchaseItemDao(db.Model):
    ...
    id = db.Column(String(38), primary_key=True)
    order_id = db.Column(String(38), db.ForeignKey('orders.id'), nullable=False, unique=True)
    ...
    def get_all():
        ...
        Returns all purchase items in the database
        """
        return db.session.query(PurchaseItemDao).all()
    ...
    def get_by_id(id):
        ...
        Returns the purchase item with the given id
        """
        return db.session.query(PurchaseItemDao).filter_by(id=id).first()
    ...
    def get_by_order_id(order_id):
        ...
        Returns all purchase items with the given order id
        """
        return db.session.query(PurchaseItemDao).filter_by(order_id=order_id).first()
...
class PaymentDao(db.Model):
    ...
    id = db.Column(String(38), primary_key=True)
    purchase_id = db.Column(String(38), db.ForeignKey('orders.id'), nullable=False, unique=True)
    ...
    def get_by_id(payment_id):
        ...
        Returns the payment with the given id
        """
        return db.session.query(PaymentDao).filter_by(id=payment_id).first()
    ...
    def get_by_purchase_id(purchase_id):
        ...
        Returns the payment with the given purchase id
        """
        return db.session.query(PaymentDao).filter_by(purchase_id=purchase_id).first()